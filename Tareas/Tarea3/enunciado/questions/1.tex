...
\begin{enumerate}
	\item \text{[2 puntos]} Demuestre que para cada par de números $x_1\in\{0,\ldots,P-1\}$ y $x_2\in\{0,\ldots,Q-1\}$, si existe un número $x\in\{0,\ldots,N-1\}$ tal que $x\equiv_P x_1$ y $x\equiv_Q x_2$, dicho número es el único que cumple tal condición. %Esto es un caso particular del teorema chino de los restos; por supuesto, no utilice dicho teorema.
