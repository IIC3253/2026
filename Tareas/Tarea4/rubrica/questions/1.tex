...
\begin{enumerate}
      \item Tiene 0.3 puntos si la idea de su demostración es correcta pero tiene algunos
      errores menores, y tiene 0.5 puntos si su demostración está completa y correcta.

	  \item Tiene 0.3 puntos si da una idea de por qué el participante 1 no puede generar
	  una firma válida, pero su idea está incompleta o tiene errores menores, y tiene 0.5 puntos
	  si su idea está completa y correcta.

	  \item Tiene 0.3 puntos si la idea de su demostración es correcta pero tiene algunos
      errores menores, y tiene 0.5 puntos si su demostración está completa y correcta.

		\item Tiene 0.3 puntos si explica cómo se puede determinar quién hizo cada firma,
		pero su idea está incompleta o tiene errores menores, y tiene 0.5 puntos si su
		explicación está completamente correcta.
\end{enumerate}
